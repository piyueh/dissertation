...
\begin{equation}\label{eq:spectral-linear-sys}
    ...
    = 0
\end{equation}
Solving this linear system determines the values of $\theta_i$ and concludes the solving workflow of this naive spectral method.
...
Solving linear systems is intuitively faster than solving nonlinear optimization problems through 1st-order optimization methods and is cheaper than 2nd-order methods in terms of memory usage.
