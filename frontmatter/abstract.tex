...
\begin{enumerate*}[label=(\arabic*)]
    ...
    \item weak and strong scalabilities.
\end{enumerate*}
Further, we benchmarked several training strategies that had not been seen in PINNs' literature or had not been widely examined by other researchers.
...
Here we listed the key findings from the first group of our benchmarks:
\begin{enumerate}[nolistsep]
    ...
    \item If we defined work loading using the number of training points, PINNs have strong-scaling efficiencies ranging from $91\%$ with 2 GPUs in the best case to $27\%$ with 8 GPUs in the worst cast.
...
In the second part of our benchmarks, the validations of both the steady and unsteady data-free PINN solvers were successful against the 2D cylinder flow at $Re=40$.
